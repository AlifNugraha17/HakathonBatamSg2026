<template>
  <section class="py-14 bg-white border-t border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Map Container -->
      <div class="bg-white rounded-2xl sm:rounded-3xl p-2 sm:p-3 border-2 border-sky-100 shadow-xl overflow-hidden relative">
        <div id="leaflet-map" class="w-full h-[360px] sm:h-[450px] lg:h-[520px] rounded-xl sm:rounded-2xl bg-slate-100 z-10"></div>
