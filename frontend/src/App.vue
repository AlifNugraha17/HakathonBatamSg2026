      ...
      <section class="py-16 bg-slate-950 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center max-w-3xl mx-auto mb-12">
            <span class="text-xs font-bold uppercase tracking-wider text-teal-400">{{ t.feat_tag }}</span>
            <h2 class="text-2xl sm:text-3xl font-extrabold text-white mt-1">{{ t.feat_title }}</h2>
            <p class="text-xs sm:text-sm text-slate-400 mt-2">{{ t.feat_desc }}</p>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="app-card p-6 rounded-2xl border border-slate-800">
              <div class="w-10 h-10 rounded-xl bg-sky-500/10 text-sky-400 flex items-center justify-center text-xl font-bold mb-4 border border-sky-500/20">
                🏥
              </div>
              <h3 class="text-base font-bold text-white mb-2">{{ t.feat_1_title }}</h3>
            ...
            <div class="app-card p-6 rounded-2xl border border-slate-800">
              <div class="w-10 h-10 rounded-xl bg-emerald-500/10 text-emerald-400 flex items-center justify-center text-xl font-bold mb-4 border border-emerald-500/20">
                💰
              </div>
              <h3 class="text-base font-bold text-white mb-2">{{ t.feat_2_title }}</h3>
              <p class="text-xs text-slate-400 leading-relaxed">
                {{ t.feat_2_desc }}
              </p>
            </div>
            ...
            <div class="app-card p-6 rounded-2xl border border-slate-800">
              <div class="w-10 h-10 rounded-xl bg-amber-500/10 text-amber-400 flex items-center justify-center text-xl font-bold mb-4 border border-amber-500/20">
                🚕
              </div>
              <h3 class="text-base font-bold text-white mb-2">{{ t.feat_3_title }}</h3>
              <p class="text-xs text-slate-400 leading-relaxed">
                {{ t.feat_3_desc }}
              </p>
            </div>
...
// Realistic Data for SG ⇄ Batam Cross-Border Tourism Hub
const places = ref([
  // ==========================================
